...
// if avalible than uncomment above code and remove below code
    ...
    return (
        <section className="bg-[#F8F8FF]">
            <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div className="max-w-2xl">
                        <p data-aos="fade-up" className="text-sm font-medium text-[#00292D]/70">
                            Listings
                        </p>
                        <h2
                            data-aos="fade-up"
                            className="mt-2 text-balance text-3xl font-semibold tracking-tight text-[#00292D] sm:text-4xl"
                        >
                            Featured properties tailored to your next move.
                        </h2>
                        <p
                            data-aos="fade-up"
                            className="mt-3 text-pretty text-base text-[#00292D]/70 sm:text-lg"
                        >
                            Browse a hand-picked selection across sale, rent, and off-plan opportunities.
                        </p>
                    </div>
                    ...
                    <div data-aos="fade-up" className="flex flex-wrap items-center gap-2">
                        <Button asChild className="bg-[#00292D] text-[#F8F8FF] hover:bg-[#00292D]/90">
                            <Link href="/buy/properties-for-sale">View all</Link>
                        </Button>
                    </div>
                </div>

                <div className="mt-10 overflow-hidden rounded-2xl bg-white ring-1 ring-[#00292D]/10">
                    <div className="p-6 sm:p-8">
                        ...
                        <h3 className="mt-3 text-balance text-xl font-semibold tracking-tight text-[#00292D] sm:text-2xl">
                            Featured properties
                        </h3>

                        <p className="mt-2 max-w-2xl text-pretty text-sm leading-relaxed text-[#00292D]/70 sm:text-base">
                            Coming soon.
                        </p>
                        ...
                        <div className="mt-5 flex flex-wrap items-center gap-3">
                            ...
                            <Link href="/about" className="text-sm font-semibold text-[#00292D] hover:underline">
                                Learn more
                            </Link>
                        </div>
                    </div>

            ...
            <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
                <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
                    <div className="lg:col-span-7">
                        <div
                            data-aos="fade-up"
                            className="inline-flex items-center rounded-full bg-[#D2C4FB]/20 px-3 py-1 text-xs font-semibold text-[#00292D] ring-1 ring-[#00292D]/10"
                        >
                            New feature
                        </div>
                        ...
                        <h2
                            data-aos="fade-up"
                            className="mt-4 text-balance text-3xl font-semibold tracking-tight text-[#00292D] sm:text-4xl"
                        >
                        ...
                        <p
                            data-aos="fade-up"
                            className="mt-4 max-w-2xl text-pretty text-base leading-relaxed text-[#00292D]/70 sm:text-lg"
                        >
                    ...
                    <div className="lg:col-span-5">
                        <div className="space-y-6">
                            ...
                            <Link href="/about">
                                <Button
                                    data-aos="fade-up"
                                    className="w-fit rounded-full bg-[#00292D] px-6 text-[#F8F8FF] hover:bg-[#00292D]/90"
                                >
                                    Explore Strathmond
                                </Button>
                            </Link>
                ...
                <div
                    data-aos="zoom-in-up"
                    className="mt-12 overflow-hidden rounded-xl bg-white ring-1 ring-[#00292D]/10 md:rounded-[28px]"
                >
                    <div className="relative">
                        <video
                            ref={videoRef}
                            className="h-auto w-full"
                            src="https://www.pexels.com/download/video/11630727/"
